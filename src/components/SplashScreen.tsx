      ...
      <div className={'dark text-foreground'}>
        <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-background animate-in fade-in duration-500">
          <div className="relative">
            <div className="flex h-24 w-24 items-center justify-center rounded-2xl text-primary-foreground bg-primary shadow-2xl animate-bounce">
              <Package size={48} />
            </div>
            <div className="absolute -bottom-12 left-1/2 -translate-x-1/2 w-48 text-center">
              <h1 className="text-3xl font-bold tracking-tighter my-4">Presyo</h1>
